...
module.exports = async function (deployer) {
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .addSchedule("DSP", "Design Phase", web3.utils.toWei("1.25", "ether"), {
        from: programmerWallet,
      })
      .then(function (v) {
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .acceptProject(new Date().getTime(), { from: clientWallet })
      .then(function (v) {
        console.log(
          "Contract Accepted By:" + v.receipt.logs[0].args.clientAddress
        );
      });
  });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .startTask(0, new Date().getTime(), { from: programmerWallet })
      .then(function (v) {
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .approveTask(0, new Date().getTime(), { from: clientWallet })
      .then(function (v) {
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .releaseFunds(0, { from: programmerWallet })
      .then(function (v) {
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .fundTask(1, {
        from: clientWallet,
        value: web3.utils.toWei("2.34", "ether"),
      })
      .then(function (v) {
        console.log("Task Funded:" + v.receipt.logs[0].args.scheduleID);
      });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .startTask(1, new Date().getTime(), { from: programmerWallet })
      .then(function (v) {
        console.log("Task Started:" + v.receipt.logs[0].args.scheduleID);
      });
  });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .approveTask(1, new Date().getTime(), { from: clientWallet })
      .then(function (v) {
        console.log("Task Approved:" + v.receipt.logs[0].args.scheduleID);
      });
  });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .releaseFunds(1, { from: programmerWallet })
      .then(function (v) {
        console.log("Funds Released:" + v.receipt.logs[0].args.scheduleID);
      });
  });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .fundTask(2, {
        from: clientWallet,
        value: web3.utils.toWei("3.25", "ether"),
      })
      .then(function (v) {
        console.log("Task Funded:" + v.receipt.logs[0].args.scheduleID);
      });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .startTask(2, new Date().getTime(), { from: programmerWallet })
      .then(function (v) {
        console.log("Task Started:" + v.receipt.logs[0].args.scheduleID);
      });
  });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .approveTask(2, new Date().getTime(), { from: clientWallet })
      .then(function (v) {
        console.log("Task Approved:" + v.receipt.logs[0].args.scheduleID);
      });
  });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .releaseFunds(2, { from: programmerWallet })
      .then(function (v) {
        console.log("Funds Released:" + v.receipt.logs[0].args.scheduleID);
      });
  });
  ...
  await freelancer.deployed().then(async function (contractInstance) {
    await contractInstance
      .endProject(new Date().getTime(), { from: programmerWallet })
      .then(function (v) {
